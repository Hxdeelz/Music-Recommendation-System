document.addEventListener('DOMContentLoaded', () => {
    // Attach listener for suggestions on input
    const songInput = document.getElementById('song-name');
    songInput.addEventListener('input', fetchSuggestions);

    // Attach listener for recommendations on button click
    const searchButton = document.querySelector('.search-container button'); // Replace with the exact button selector
